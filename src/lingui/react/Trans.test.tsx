...
describe('Trans component', function () {
  ...
  it('should render a variable wrapped in a component', () => {
    const props = {
      id: 'Beginning, middle <0>{0}</0>',
      values: {
        '0': 'end',
      },
      components: {
    ...
    const translation = html(<Trans {...props} />);
    expect(translation).toEqual('Beginning, middle <strong>end</strong>');
  });
